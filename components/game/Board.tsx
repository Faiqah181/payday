...
export default function Board({
  ...
  useEffect(() => {
    ...
    animX.value = timingsX.length === 1 ? timingsX[0] : withSequence(...(timingsX as [number, ...number[]]));
    animY.value = timingsY.length === 1 ? timingsY[0] : withSequence(...(timingsY as [number, ...number[]]));
        ...
        {animatingMove && (
          ...
          >
            <View style={styles.pawn}>
              <View style={[styles.pawnHead, { backgroundColor: animatingColor }]} />
              <View style={[styles.pawnBody, { backgroundColor: animatingColor }]} />
              <View style={[styles.pawnBase, { backgroundColor: animatingColor }]} />
            </View>
          </Animated.View>
        )}
      </View>
