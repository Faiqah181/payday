...
// Ballot/podium "politics" icon (svgrepo, CC0) used for Town Election.
const ELECTION_XML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
<g>
...
export default function ElectionIcon({ size = 56 }: { size?: number }) {
  return <SvgXml xml={ELECTION_XML} width={size} height={size} />;
}
